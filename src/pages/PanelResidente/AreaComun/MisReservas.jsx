...
export default function MisReservas() {
    ...
    useEffect(() => {
        const obtenerReservas = async () => {
            try {
                ...
                const url = `https://abitare-back-production.up.railway.app/api/area-comun/residente/reservas/:${id_usuario}`;
                // console.log(url)
    ...
    const handleEliminar = async (e) => {
        ...
        try {
            ...
            const res = await fetch(`https://abitare-back-production.up.railway.app/api/area-comun/residente/eliminar-reserva/:${idReserva}`, {
                method: "DELETE",
                credentials: "include",
            });
    ...
    const handleEditar = async (e) => {
        ...
        try {
            const res = await fetch(`https://abitare-back-production.up.railway.app/api/area-comun/residente/editar-reserva`, {
                method: "PUT",
