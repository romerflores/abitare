...
const Actualizar = ({ id_personal, set_page}) => {
    ...
    useEffect(() => {
        const obtenerDatosPersonal = async () => {
            try {
                const conexion = await fetch(`https://abitare-back-production.up.railway.app/api/administrador/obtener-personal/:${id}`, {
                    method: 'GET',
                    credentials: 'include'
                });
    ...
    const actualizarDatosPersonal = async (e) => {
        ...
        try {
            const conexion = await fetch('https://abitare-back-production.up.railway.app/api/administrador/actualizar-personal', {
                method: 'PUT',
                headers: {
