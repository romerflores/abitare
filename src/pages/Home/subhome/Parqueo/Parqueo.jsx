...
export function Parqueo() {
    ...
    useEffect(() => {
        const obtenerUsuarios = async () => {
            try {
                const res = await fetch("https://abitare-back-production.up.railway.app/api/estacionamiento", {
                    method: "GET",
    ...
    const handleSubmitLibre = async (element) => {
        ...
        try {
            const respuesta= await fetch("https://abitare-back-production.up.railway.app/api/estacionamiento/registrar-entrada",
                {
                    method:"POST",
                    headers:{
    ...
    const handleSubmitSalida = async (element) => {
        element.preventDefault()
        try {
            const respuesta = await fetch("https://abitare-back-production.up.railway.app/api/estacionamiento/registrar-salida",
                {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json"
