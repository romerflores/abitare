...
export default function AreaComun() {
    ...
    useEffect(() => {
        fetch("http://localhost:10000/api/area-comun").then((res) => res.json()).then((data) => {
    ...
    const handleSubmitCrear = async (e) => {
        ...
        try {
            const response = await fetch("http://localhost:10000/api/area-comun/crear", {
                method: "POST",
                headers: {
            ...
            if (response.status === 200) {
                ...
                const areasResponse = await fetch("http://localhost:10000/api/area-comun", {
                    method: "GET",
    ...
    const handleSubmitEditar = async (e) => {
        ...
        try {
            const response = await fetch("http://localhost:10000/api/area-comun/actualizar", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const handleEliminar = async (e) => {
        ...
        try {
            const response = await fetch(`http://localhost:10000/api/area-comun/eliminar/${currtId}`, {
                method: "DELETE",
                credentials: 'include'
            });
